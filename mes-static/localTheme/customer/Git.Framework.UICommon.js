...
var AccountSetting = {
    Add: function () {
        ...
        $.jBox.open("get:/rest/user/accountSetting", "编辑用户", 500, 270, {buttons: {"确定": true, "关闭": false}, submit: submit});
    },
    Edit: function () {
        var submit = function (v, h, f) {
            if (v == true) {
        ...
        $.jBox.open("get:/rest/user/changePwd", "修改密码", 350, 200, {buttons: {"确定": true, "关闭": false}, submit: submit});
    }
};