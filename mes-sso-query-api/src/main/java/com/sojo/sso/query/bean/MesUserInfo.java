package com.sojo.sso.query.bean;

import java.util.Date;

import com.fasterxml.jackson.annotation.JsonIgnore;

public class MesUserInfo implements java.io.Serializable {

    private static final long serialVersionUID = -4590747248167417127L;
